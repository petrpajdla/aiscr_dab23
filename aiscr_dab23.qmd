...
:::: {.columns}
::: {.column width="50%"}
![Cadastral units with no projects registered (2016--2023).](img/noproj.png)

- In some *cadastral units* no [projects]{.proj} were  
  registered yet (since 2016). 
:::
::: {.column width="50%"}
